  ...
  return (
    <section className="py-20 bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      <div className="max-w-5xl mx-auto px-4">
        <h1 className="text-4xl font-bold mb-6 text-gray-900 dark:text-white">Market Analysis</h1>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {insights.map((insight, index) => {
            ...
            return (
              <div key={index} className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-8 hover:shadow-lg transition-all">
